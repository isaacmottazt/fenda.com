...
const SHELL = [
  ...
  '/js/player-session.js', '/js/share-ui.js?v=share-ui-v1', '/js/notifications.js', '/css/notifications.css', '/js/inicio-extras.js', '/js/podcasts.js',
