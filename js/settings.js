...
`;
    ...
    function _buildOverlay() {
        ...
        _overlay.innerHTML = `
          ...
          <div class="fs-body">
            ...
            <div class="fs-section">Aparência</div>
            <div class="fs-card fs-theme-card">
              <div class="fs-form fs-theme-intro">
                <strong>Escolha seu jeito de usar o Fenda</strong>
                <p class="fs-hint">O conteúdo e o player continuam os mesmos; só a organização e a linguagem visual mudam.</p>
              </div>
              <div class="fs-theme-options">
                <button type="button" class="fs-theme-option" data-design-option="classic" aria-pressed="false">
                  <span class="fs-theme-preview fs-theme-preview-classic"><i></i><i></i><i></i></span>
                  <span class="fs-theme-option-copy"><b>Visual atual</b><small>Violeta, compacto e focado em ouvir</small></span>
                  <span class="material-symbols-rounded fs-theme-check">check_circle</span>
                </button>
                <button type="button" class="fs-theme-option" data-design-option="admin" aria-pressed="false">
                  <span class="fs-theme-preview fs-theme-preview-admin"><i></i><i></i><i></i></span>
                  <span class="fs-theme-option-copy"><b>Workspace Admin</b><small>Azul, ciano e navegação lateral</small></span>
                  <span class="material-symbols-rounded fs-theme-check">check_circle</span>
                </button>
              </div>
            </div>
        ...
        const refreshDesignOptions = () => {
            const selected = window.FendaDesign?.get?.() || localStorage.getItem('fenda-design') || 'classic';
            _overlay.querySelectorAll('[data-design-option]').forEach((button) => {
                const active = button.dataset.designOption === selected;
    ...
    window.FendaSettings = { open, close, getPrefs, getPlaybackPrefs, getAppPrefs, getDesign: () => window.FendaDesign?.get?.() || localStorage.getItem('fenda-design') || 'classic' };
