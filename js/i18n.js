...
(function () {
    ...
    const DICT = {
        ...
        'en-US': {
            ...
            privacy_section: 'Privacy and data', privacy_intro: 'Choose which data Fenda Music may use. You can change or revoke these choices at any time.', privacy_analytics: 'Usage analytics', privacy_analytics_sub: 'Uses your listening history and searches to measure performance and improve the app.', privacy_recommendations: 'Personalized recommendations', privacy_recommendations_sub: 'Uses your history to adapt suggestions, personal rankings and discovery.', privacy_location: 'Precise location', privacy_location_sub: 'Allows GPS use for region-based features. Your browser will ask for permission.', privacy_device: 'Device technical data', privacy_device_sub: 'Uses language, time zone and platform without storing the browser raw identifier.', privacy_location_enabled: 'Location authorized', privacy_location_disabled: 'Location disabled', privacy_saved: 'Privacy preference updated.', privacy_load_error: 'Could not load your privacy preferences.', privacy_location_error: 'Could not authorize location.', privacy_data_note: 'Authorized data is linked to your account and deleted when the account is deleted. Fenda does not store an IP in your profile; technical security logs may exist with infrastructure providers under their own policies.', privacy_prompt_title: 'Choose how your data is used', privacy_prompt_intro: 'Before continuing, choose which information Fenda Music may use. Nothing is enabled without your decision.', privacy_prompt_decline: 'Do not accept now', privacy_prompt_all: 'Accept all', privacy_prompt_save: 'Save choices', privacy_prompt_footer: 'You can change or revoke these choices in Settings → Privacy and data. Precise location is read only with browser permission.', privacy_prompt_location_wait: 'Waiting for location permission…', privacy_prompt_saving: 'Saving your choices…', privacy_prompt_error: 'Could not save now. Please try again.',
