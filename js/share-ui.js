...
(function () {
  ...
  const ShareUIHandler = {
    ...
    getUrl(music) {
      const url = new URL('/inicio', window.location.origin);
    ...
    injectStyles() {
      ...
      style.textContent = `.song-share-modal{position:fixed;inset:0;z-index:240;display:grid;place-items:center;padding:18px;background:rgba(3,7,15,.72);backdrop-filter:blur(12px);opacity:0;pointer-events:none;transition:opacity .18s ease}.song-share-modal.is-open{opacity:1;pointer-events:auto}.song-share-dialog{position:relative;width:min(100%,460px);padding:24px;background:linear-gradient(145deg,#13243b,#0d1525);border:1px solid rgba(126,232,225,.24);border-radius:24px;box-shadow:0 28px 90px rgba(0,0,0,.48);transform:translateY(8px) scale(.98);transition:transform .2s cubic-bezier(.23,1,.32,1)}.song-share-modal.is-open .song-share-dialog{transform:none}.song-share-close{position:absolute;top:14px;right:14px;width:34px;height:34px;display:grid;place-items:center;color:#b8c3d9;background:rgba(255,255,255,.06);border:1px solid rgba(173,196,232,.14);border-radius:10px;cursor:pointer}.song-share-close:hover{color:#7ee8e1;border-color:rgba(126,232,225,.35)}.song-share-kicker{display:flex;align-items:center;gap:8px;color:#7ee8e1;font-size:11px;font-weight:800;letter-spacing:.12em;text-transform:uppercase}.song-share-preview{display:flex;align-items:center;gap:15px;margin-top:22px;padding:13px;background:rgba(255,255,255,.045);border:1px solid rgba(173,196,232,.12);border-radius:17px}.song-share-cover{width:74px;height:74px;display:grid;place-items:center;flex:0 0 auto;overflow:hidden;color:#7ee8e1;background:linear-gradient(145deg,#263e5c,#17263d);border-radius:14px}.song-share-cover img{width:100%;height:100%;object-fit:cover}.song-share-cover img[hidden],.song-share-cover span[hidden]{display:none}.song-share-copy{min-width:0;padding-right:25px}.song-share-copy h2,.song-share-copy p,.song-share-copy span{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.song-share-copy h2{font-size:18px;letter-spacing:-.04em}.song-share-copy p{margin-top:5px;color:#b8c3d9;font-size:12px}.song-share-copy span{margin-top:8px;color:#73819b;font-size:10px}.song-share-actions{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px;margin-top:17px}.song-share-actions button{min-height:68px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:7px;color:#c5dbff;background:rgba(255,255,255,.045);border:1px solid rgba(173,196,232,.12);border-radius:13px;font-size:10px;font-weight:800;cursor:pointer;transition:background .16s,border-color .16s,transform .16s}.song-share-actions button:hover{color:#7ee8e1;background:rgba(126,232,225,.09);border-color:rgba(126,232,225,.3);transform:translateY(-1px)}.song-share-actions button:active{transform:scale(.97)}.song-share-actions .material-symbols-rounded{font-size:21px}.song-share-link-row{display:flex;align-items:center;gap:8px;min-width:0;margin-top:14px;padding:10px 11px;color:#73819b;background:rgba(0,0,0,.16);border-radius:10px;font-size:10px}.song-share-link-row span:last-child{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}@media(max-width:520px){.song-share-dialog{padding:20px 15px}.song-share-actions{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(prefers-reduced-motion:reduce){.song-share-modal,.song-share-dialog{transition:none}}`;
